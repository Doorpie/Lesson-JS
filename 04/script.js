...
// var b = 7;
// var result;
// if  (a > 2 && b<11 || b>=6 && b<14) alert('Верно');
// else alert('Неверно');
...
// var day = 10;
// if (day>=1 && day<=10) alert('Первая');
// if (day>=11 && day<=20) alert('Вторая');
// if (day>=21 && day<=31) alert('Третья');
...
// var str = '123326';
// var num1 = Number(str[0])+Number(str[1])+Number(str[2]);
// var num2 = Number(str[3])+Number(str[4])+Number(str[5]);
// if (num1==num2) alert('Да');
// else alert ('Нет');